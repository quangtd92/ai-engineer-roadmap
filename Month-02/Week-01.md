...
`data/raw/intent_samples.csv`, `scripts/prepare_intent_data.py`, `app/ml/preprocessing.py`, test cho preprocessing và tài liệu `docs/data-pipeline.md`.
